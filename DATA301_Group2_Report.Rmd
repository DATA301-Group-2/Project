...
vars <- data_clean %>%
  select(
    ...
    `Low-access Population (Proportion)` = lapop1share,
    `Low-access Children (Proportion)` = lakids1share,
    `Low-access Seniors (Proportion)` = laseniors1share,
    `No Vehicle Households (Proportion)` = lahunv1share
  )
